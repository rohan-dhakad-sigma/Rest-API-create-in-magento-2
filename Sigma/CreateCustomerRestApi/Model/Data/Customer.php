...
namespace Sigma\CreateCustomerRestApi\Model\Data;
...
class Customer extends \Magento\Framework\Api\AbstractExtensibleObject implements
    \Sigma\CreateCustomerRestApi\Api\Data\CustomerInterface
{
    /**
    ...
    {
        return $this->_get(self::CUSTOMERNUMBER);
    }
    ...
    {
        return $this->setData(self::CUSTOMERNUMBER, $customernumber);
    }
